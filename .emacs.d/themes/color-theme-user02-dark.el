...
;; basic
     ...
     (secondary-selection                 ((t ( :foreground "#000000"  :background "yellow1"))))
...
;;    (markdown-url-face                     ((t (:inherit font-lock-string-face))))
     ...
     (yascroll:thumb-face                 ((t ( :inherit highlight))))
)))

(add-to-list 'color-themes '(color-theme-user02-dark  "user02-dark" "QRG"))
